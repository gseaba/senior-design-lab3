...
def profile(name):
    ...
    members = {
        ...
        'bo': {'name': 'Partner Name', 'bio': 'Electrical Engineering student.', 'interests': ['IoT', 'Web Dev'], 'img': 'default.png'},
        'jane': {'name': 'Jane', 'bio': 'Electrical Engineering student', 'interests': ['IoT', 'Web Dev'], 'img': 'default.png'}
    }
